function createICSFile() {
  ...
  ICSdescription = document.getElementById('description').value; //long description
  ...
  //Generates an endtime for your event. You should remove this and use your own endtime.
